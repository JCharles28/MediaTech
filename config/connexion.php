...
class Connexion {
  // les attributs static caractéristiques de la connexion
	...
	static private $database = 'sae-s3-jmchang';      // votre id court
	static private $login = 'sae-s3-jmchang';         // votre id court
	static private $password = 'uUEVPJ7r40Wi11si'; // votre mdp
